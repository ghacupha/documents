...
describe('Component Tests', () => {
  describe('TransactionDocument Management Delete Component', () => {
    let comp: TransactionDocumentDeleteDialogComponent;
    let fixture: ComponentFixture<TransactionDocumentDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [TransactionDocumentDeleteDialogComponent]
      })
        .overrideTemplate(TransactionDocumentDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(TransactionDocumentDeleteDialogComponent);
