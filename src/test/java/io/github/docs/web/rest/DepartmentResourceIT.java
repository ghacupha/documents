...
import io.github.docs.service.DepartmentService;
...
import io.github.docs.service.DepartmentQueryService;
...
public class DepartmentResourceIT {
    ...
    @Test
    @Transactional
    public void getAllDepartmentsByDepartmentNumberIsEqualToSomething() throws Exception {
        // Initialize the database
        departmentRepository.saveAndFlush(department);

        // Get all the departmentList where departmentNumber equals to DEFAULT_DEPARTMENT_NUMBER
        defaultDepartmentShouldBeFound("departmentNumber.equals=" + DEFAULT_DEPARTMENT_NUMBER);

        // Get all the departmentList where departmentNumber equals to UPDATED_DEPARTMENT_NUMBER
        defaultDepartmentShouldNotBeFound("departmentNumber.equals=" + UPDATED_DEPARTMENT_NUMBER);
    }

    @Test
    @Transactional
    public void getAllDepartmentsByDepartmentNumberIsNotEqualToSomething() throws Exception {
        // Initialize the database
        departmentRepository.saveAndFlush(department);

        // Get all the departmentList where departmentNumber not equals to DEFAULT_DEPARTMENT_NUMBER
        defaultDepartmentShouldNotBeFound("departmentNumber.notEquals=" + DEFAULT_DEPARTMENT_NUMBER);

        // Get all the departmentList where departmentNumber not equals to UPDATED_DEPARTMENT_NUMBER
        defaultDepartmentShouldBeFound("departmentNumber.notEquals=" + UPDATED_DEPARTMENT_NUMBER);
    }

    @Test
    @Transactional
    public void getAllDepartmentsByDepartmentNumberIsInShouldWork() throws Exception {
        // Initialize the database
        departmentRepository.saveAndFlush(department);

        // Get all the departmentList where departmentNumber in DEFAULT_DEPARTMENT_NUMBER or UPDATED_DEPARTMENT_NUMBER
        defaultDepartmentShouldBeFound("departmentNumber.in=" + DEFAULT_DEPARTMENT_NUMBER + "," + UPDATED_DEPARTMENT_NUMBER);

        // Get all the departmentList where departmentNumber equals to UPDATED_DEPARTMENT_NUMBER
        defaultDepartmentShouldNotBeFound("departmentNumber.in=" + UPDATED_DEPARTMENT_NUMBER);
    }

    @Test
    @Transactional
    public void getAllDepartmentsByDepartmentNumberIsNullOrNotNull() throws Exception {
        // Initialize the database
        departmentRepository.saveAndFlush(department);

        // Get all the departmentList where departmentNumber is not null
        defaultDepartmentShouldBeFound("departmentNumber.specified=true");

        // Get all the departmentList where departmentNumber is null
        defaultDepartmentShouldNotBeFound("departmentNumber.specified=false");
    }
                @Test
    @Transactional
    public void getAllDepartmentsByDepartmentNumberContainsSomething() throws Exception {
        // Initialize the database
        departmentRepository.saveAndFlush(department);

        // Get all the departmentList where departmentNumber contains DEFAULT_DEPARTMENT_NUMBER
        defaultDepartmentShouldBeFound("departmentNumber.contains=" + DEFAULT_DEPARTMENT_NUMBER);

        // Get all the departmentList where departmentNumber contains UPDATED_DEPARTMENT_NUMBER
        defaultDepartmentShouldNotBeFound("departmentNumber.contains=" + UPDATED_DEPARTMENT_NUMBER);
    }

    @Test
    @Transactional
    public void getAllDepartmentsByDepartmentNumberNotContainsSomething() throws Exception {
        // Initialize the database
        departmentRepository.saveAndFlush(department);

        // Get all the departmentList where departmentNumber does not contain DEFAULT_DEPARTMENT_NUMBER
        defaultDepartmentShouldNotBeFound("departmentNumber.doesNotContain=" + DEFAULT_DEPARTMENT_NUMBER);

        // Get all the departmentList where departmentNumber does not contain UPDATED_DEPARTMENT_NUMBER
        defaultDepartmentShouldBeFound("departmentNumber.doesNotContain=" + UPDATED_DEPARTMENT_NUMBER);
    }
