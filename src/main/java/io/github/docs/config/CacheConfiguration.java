...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("documents");
        ...
        config.getMapConfigs().put("io.github.docs.domain.*", initializeDomainMapConfig(jHipsterProperties));
