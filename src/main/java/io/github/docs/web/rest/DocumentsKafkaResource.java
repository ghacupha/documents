...
import io.github.docs.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/documents-kafka")
public class DocumentsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DocumentsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public DocumentsKafkaResource(KafkaProperties kafkaProperties) {
